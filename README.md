...
1. 배대지 도착시 한국주소로 출발한다
1. 통관이 승인되면 국내 배송이 진행된다 (국내배송)
1. 고객이 주문상태를 중간중간 조회할 수 있다
...
1. 장애격리
    ...
    1. 배대지배송, 국내배송 기능이 수행되지 않더라도 주문은 365일 24시간 받을 수 있어야 한다 Async (event-driven), Eventual Consistency
    1. shipping 처리 지연시 주문취소 처리를  잠시후에 하도록 유도한다 Circuit breaker, fallback
1. 성능
    1. 고객이 자주 주문한 상품의 배송 상태를 주문시스템(프론트엔드)에서 확인할 수 있어야 한다 CQRS
...
![image](https://user-images.githubusercontent.com/117131393/209895660-bd0dd01f-a52a-459f-9b2f-c1a708e76f80.JPG)
